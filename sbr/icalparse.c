...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ICAL_NAME = 3,                  /* ICAL_NAME  */
  YYSYMBOL_ICAL_COLON = 4,                 /* ICAL_COLON  */
  YYSYMBOL_ICAL_VALUE = 5,                 /* ICAL_VALUE  */
  YYSYMBOL_ICAL_CRLF = 6,                  /* ICAL_CRLF  */
  YYSYMBOL_ICAL_SEMICOLON = 7,             /* ICAL_SEMICOLON  */
  YYSYMBOL_ICAL_PARAM_NAME = 8,            /* ICAL_PARAM_NAME  */
  YYSYMBOL_ICAL_EQUAL = 9,                 /* ICAL_EQUAL  */
  YYSYMBOL_ICAL_PARAM_VALUE = 10,          /* ICAL_PARAM_VALUE  */
  YYSYMBOL_ICAL_COMMA = 11,                /* ICAL_COMMA  */
  YYSYMBOL_YYACCEPT = 12,                  /* $accept  */
  YYSYMBOL_contentline_list = 13,          /* contentline_list  */
  YYSYMBOL_contentline = 14,               /* contentline  */
  YYSYMBOL_15_1 = 15,                      /* $@1  */
  YYSYMBOL_16_2 = 16,                      /* $@2  */
  YYSYMBOL_17_3 = 17,                      /* $@3  */
  YYSYMBOL_18_4 = 18,                      /* $@4  */
  ...
  YYSYMBOL_25_9 = 25,                      /* $@9  */
  YYSYMBOL_26_10 = 26,                     /* $@10  */
  YYSYMBOL_param_value_list = 27,          /* param_value_list  */
  YYSYMBOL_28_11 = 28                      /* $@11  */
};
...
{
       0,    61,    61,    62,    66,    70,    72,    66,    91,    95,
      97,    91,   109,   109,   112,   112,   118,   121,   118,   126,
     130,   130
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ICAL_NAME",
  "ICAL_COLON", "ICAL_VALUE", "ICAL_CRLF", "ICAL_SEMICOLON",
  "ICAL_PARAM_NAME", "ICAL_EQUAL", "ICAL_PARAM_VALUE", "ICAL_COMMA",
  "$accept", "contentline_list", "contentline", "$@1", "$@2", "$@3", "$@4",
  "$@5", "$@6", "param_list", "$@7", "$@8", "param", "$@9", "$@10",
  "param_value_list", "$@11", YY_NULLPTR
};
...
{
       0,     4,     0,     2,     0,     0,     1,     3,     5,    12,
       0,     0,     0,     9,    14,     6,    16,    13,     0,     0,
       0,     0,    10,    15,     7,    17,     0,     0,    11,    19,
      18,    20,     0,    21
};
...
{
       0,     2,     3,     4,    11,    20,     5,    18,    26,    10,
      12,    19,    17,    21,    27,    30,    32
};
...
{
       6,    13,     1,     1,    14,    -8,     8,    31,     9,    15,
      22,    16,    24,     7,    28,     0,    25,     0,     0,    29,
...
{
       0,     4,     3,     3,     7,     7,     4,    11,     7,     5,
       5,     8,     6,     2,     6,    -1,     9,    -1,    -1,    10,
...
{
       0,     3,    13,    14,    15,    18,     0,    14,     4,     7,
      21,    16,    22,     4,     7,     5,     8,    24,    19,    23,
      17,    25,     5,    24,     6,     9,    20,    26,     6,    10,
      27,    11,    28,    10
};
...
{
       0,    12,    13,    13,    15,    16,    17,    14,    18,    19,
      20,    14,    22,    21,    23,    21,    25,    26,    24,    27,
      28,    27
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* $@1: %empty  */
#line 66 "sbr/icalparse.y"
                {
          new_content_line (&vevents.last->contentlines);
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          vevents.last->contentlines->last->name = yyvsp[0];
      }
#line 1208 "sbr/icalparse.c"
    break;

  case 5: /* $@2: %empty  */
#line 70 "sbr/icalparse.y"
                   {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1216 "sbr/icalparse.c"
    break;

  case 6: /* $@3: %empty  */
#line 72 "sbr/icalparse.y"
                   {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          vevents.last->contentlines->last->value = yyvsp[0];
      }
#line 1225 "sbr/icalparse.c"
    break;

  case 7: /* contentline: ICAL_NAME $@1 ICAL_COLON $@2 ICAL_VALUE $@3 ICAL_CRLF  */
#line 75 "sbr/icalparse.y"
                  {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          if (vevents.last->contentlines->cr_before_lf == CR_UNSET) {
              vevents.last->contentlines->cr_before_lf =
                  yyvsp[0][0] == '\r'  ?  CR_BEFORE_LF  :  LF_ONLY;
          }
...
#line 1246 "sbr/icalparse.c"
    break;

  case 8: /* $@4: %empty  */
#line 91 "sbr/icalparse.y"
                {
          new_content_line (&vevents.last->contentlines);
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          vevents.last->contentlines->last->name = yyvsp[0];
      }
#line 1256 "sbr/icalparse.c"
    break;

  case 9: /* $@5: %empty  */
#line 95 "sbr/icalparse.y"
                              {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1264 "sbr/icalparse.c"
    break;

  case 10: /* $@6: %empty  */
#line 97 "sbr/icalparse.y"
                   {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          vevents.last->contentlines->last->value = yyvsp[0];
      }
#line 1273 "sbr/icalparse.c"
    break;

  case 11: /* contentline: ICAL_NAME $@4 param_list ICAL_COLON $@5 ICAL_VALUE $@6 ICAL_CRLF  */
#line 100 "sbr/icalparse.y"
                  {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          if (vevents.last->contentlines->cr_before_lf == CR_UNSET) {
              vevents.last->contentlines->cr_before_lf =
...
#line 1285 "sbr/icalparse.c"
    break;

  case 12: /* $@7: %empty  */
#line 109 "sbr/icalparse.y"
                     {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1293 "sbr/icalparse.c"
    break;

  case 14: /* $@8: %empty  */
#line 112 "sbr/icalparse.y"
                                {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1301 "sbr/icalparse.c"
    break;

  case 16: /* $@9: %empty  */
#line 118 "sbr/icalparse.y"
                      {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          add_param_name (vevents.last->contentlines->last, yyvsp[0]);
      }
#line 1310 "sbr/icalparse.c"
    break;

  case 17: /* $@10: %empty  */
#line 121 "sbr/icalparse.y"
                   {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1318 "sbr/icalparse.c"
    break;

  case 19: /* param_value_list: ICAL_PARAM_VALUE  */
#line 126 "sbr/icalparse.y"
                       {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          add_param_value (vevents.last->contentlines->last, yyvsp[0]);
      }
#line 1327 "sbr/icalparse.c"
    break;

  case 20: /* $@11: %empty  */
#line 130 "sbr/icalparse.y"
                                  {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
      }
#line 1335 "sbr/icalparse.c"
    break;

  case 21: /* param_value_list: param_value_list ICAL_COMMA $@11 ICAL_PARAM_VALUE  */
#line 132 "sbr/icalparse.y"
                         {
          append (vevents.last->contentlines->last, yyvsp[0], strlen (yyvsp[0]));
          add_param_value (vevents.last->contentlines->last, yyvsp[0]);
      }
#line 1344 "sbr/icalparse.c"
    break;


#line 1348 "sbr/icalparse.c"
